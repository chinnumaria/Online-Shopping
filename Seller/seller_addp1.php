		<?php	
					$con=mysqli_connect("localhost","maria","maria","os");
						...
						$sql= "insert into product(p_name,p_cat,p_brand,p_price,p_dis,p_desc,p_img,p_key,p_qty,p_seller,p_select) values('$name','$cat','$brand','$price','$dis','$des','$ipath','$keyw','$qty','$sel','$sele');";

       ...
       <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
         ...
         <ul class="treeview-menu">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="Admin_vbook.php"><i class="fa fa-circle-o"></i> View Users</a></li>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
				 ...
				 <?php
								...
								$sel="SELECT * from registration where usertype=1";
								$res=mysqli_query($con,$sel);
							
								if(mysqli_num_rows($res)>0){
									while($row=$res->fetch_assoc()){
									
									echo "<tr><td>". $row["uid"]. "</td><td>" .$row["name"]. "</td><td>" .$row["gender"]. "</td><td>" .$row["mob"]. "</td><td>" .$row["email"]. "</td>

		...
		<li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li><a href="Admin_pd.php"><i class="fa fa-circle-o"></i> Purchase</a></li>
			 <li class="active"><a href="Admin_ssalary.php"><i class="fa fa-circle-o"></i> Salary</a></li>
          </ul>
        </li>
  </aside>
       ...
       <div class="row">
        ...
        <!-- /.col -->
            ...
            <div class="box-header">
              <h2 align="center">Salary Details</h3>
            </div>
                ...
                <tr>
				 ...
				 <?php
								...
								if(mysqli_num_rows($res)>0){
									...
									echo "<tr><td>". $row["slid"]. "</td><td>" .$row["sid"]. "</td><td>" .$row["sname"]. "</td><td>" .$row["amt"]. "</td><td>" .$row["paid"]. "</td><td>$pro</td><td>" .$row["curdate"]. "</td>

                ...
                <tr>
				 ...
				 <?php
								...
								if(mysqli_num_rows($res)>0){
									...
									echo "<tr><td>". $row["s_id"]. "</td><td>" .$row["s_name"]. "</td><td>" .$row["s_owner"]. "</td><td>" .$row["s_email"]. "</td><td>" .$row["s_mob"]. "</td><td>" .$row["s_place"]. "</td><td align='middle'> <div class='btn-group'>
				  <div class='btn-group'>
				  ...
				  Options
                    ...
                    <span class='sr-only'>Toggle Dropdown</span>				
                        ...
                        <ul class='dropdown-menu'>
                          <li><a href='Admin_slrd.php?x=". $row["s_id"]. "'>Delete</a></li>
                        </ul>
                   </div>
                    </div></td></tr>";
									} 

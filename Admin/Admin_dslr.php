              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
				 ...
				 <?php
								...
								$sel="SELECT * from seller where apr='Y'";
								$res=mysqli_query($con,$sel);
							
								if(mysqli_num_rows($res)>0){
									while($row=$res->fetch_assoc()){
									
									echo "<tr><td>". $row["s_id"]. "</td><td>" .$row["s_name"]. "</td><td>" .$row["s_owner"]. "</td><td>" .$row["s_email"]. "</td><td>" .$row["s_mob"]. "</td><td>" .$row["s_adr"]. "</td>
									<td><div class='box-tools'>
									<button type='button' class='btn btn-info btn-sm'  data-toggle='tooltip' title='Message' onclick=window.location.href='msgslr.php?x=". $row["s_id"]. "'>
									<i class='fa fa-envelope-o' ></i></button>
									<button type='button' class='btn btn-info btn-sm'  data-toggle='tooltip' title='Warning' onclick=window.location.href='wslr.php?x=". $row["s_id"]. "'>
									<i class='fa fa-warning' ></i></button>
									<button type='button' class='btn btn-info btn-sm' name='delete' data-toggle='tooltip'
									title='Remove' onclick=window.location.href='slrdel.php?x=". $row["s_id"]. "'>

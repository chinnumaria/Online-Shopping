        ...
        <li class="treeview">
         ...
         <ul class="treeview-menu">
          ...
          <ul class="treeview-menu">
			...
			<li class="active"><a href="s_odet.php"><i class="fa fa-circle-o"></i> Order Details</a></li>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
				 ...
				 <?php
								...
								$sel="SELECT * from sod where seller='$n' and status='n';";
								...
								if(mysqli_num_rows($res)>0){
									...
									echo "<tr><td>$pn</td><td>$qty</td><td>$un</td><td>$mail</td><td>$mob</td><td>$adr</br> $loc</br> $city</br>$pin</td><td align='middle'> <div class='btn-group'>
				  <div class='btn-group'>
				  ...
				  Options
                    ...
                    <span class='sr-only'>Toggle Dropdown</span>				
                        ...
                        <ul class='dropdown-menu'>
                          <li><a href='s_deli.php?x=$pid&y=$un'>Delivered</a></li>

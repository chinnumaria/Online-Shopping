      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="AdminPoojaList.php">View Pooja List</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
     ...
     <ol class="breadcrumb">
		...
		<li class="active">View Pooja List</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h2 align="center">View Pooja List</h3>
            </div>
			...
			<div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
				...
				<?php
								...
								$sel="SELECT pj.pid,tmp.tname,dt.dname,pj.pname,pj.purpose,pj.amount FROM 
								...
								if(mysqli_num_rows($res)>0){
									...
									echo "<tr><td>". $row["pid"]. "</td><td>" .$row["tname"]. "</td><td>" .$row["dname"]. "</td><td>" .$row["pname"]. "</td><td>" .$row["purpose"]. "</td><td>" .$row["amount"]. "</td> ";
									echo "<td><div class='box-tools'>
									<button type='button' class='btn btn-info btn-sm'  data-toggle='tooltip' title='Collapse' onclick=window.location.href='EditPooja.php?x=". $row["pid"]. "'>
									<i class='fa fa-pencil' ></i></button>
									<button type='button' class='btn btn-info btn-sm' name='delete' data-toggle='tooltip'
									title='Remove' onclick=window.location.href='poojadel.php?x=". $row["pid"]. "'>

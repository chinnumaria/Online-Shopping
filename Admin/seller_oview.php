	...
	<section class="content" background-color="red">
       ...
       <form method="POST" action="">
            ...
            <div class="box-header">
              <h2 align="center">View Orders</h3>
            </div>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
				 ...
				 <?php
								...
								$sel="SELECT * from p_seller where sname='$n' and status='ns';";
								...
								if(mysqli_num_rows($res)>0){
									...
									echo "<tr><td>". $row["pid"]. "</td><td>". $row["pname"]. "</td><td>". $rw["name"]. "</td><td><img src='images/".$row["pimg"]."' width='100px' height='100px'></td><td>" .$row["pname"]. "</td><td>" .$row["qty"]. "</td><td>" .$row["amount"]. "</td><td>" .$row["date"]. "</td><td align='middle'> <div class='btn-group'>
				  <div class='btn-group'>
				  ...
				  Options
                    ...
                    <span class='sr-only'>Toggle Dropdown</span>				
                        ...
                        <ul class='dropdown-menu'>
                          <li><a href='s_pv.php?x=$pid&y=$una'>View</a></li>

                ...
                <tr>
				 ...
				 <?php
								...
								if(mysqli_num_rows($res)>0){
									...
									echo "<tr><td>". $row["p_id"]. "</td><td>" .$row["p_name"]. "</td><td>" .$row["p_cat"]. "</td><td>" .$row["p_brand"]. "</td><td>" .$row["p_price"]. "</td><td>" .$row["p_dis"]. "</td><td>" .$row["p_desc"]. "</td><td><img src='images/".$row["p_img"]."' width='100px' height='100px'></td><td>" .$row["p_key"]. "</td><td>" .$row["p_qty"]. "</td><td>" .$row["p_seller"]. "</td>></tr>";
									} 

       ...
       <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
         ...
         <ul class="treeview-menu">
          ...
          <ul class="treeview-menu">
		  <li class="active"><a href="Admin_fp.php"><i class="fa fa-circle-o"></i> Featured Products</a></li>
  ...
  <div class="content-wrapper">
	...
	<section class="content" background-color="red">
            ...
            <div class="box-header">
              <h2 align="center">Featured Products</h3>
            </div>
			<div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
				 ...
				 <?php
								...
								$sel="SELECT * from product where p_id IN (SELECT `pid` FROM `purchase` GROUP BY `pid` ORDER BY COUNT(*) DESC);";
								$res=mysqli_query($con,$sel);
							
								if(mysqli_num_rows($res)>0){
									while($row=$res->fetch_assoc()){
									
									echo "<tr><td>". $row["p_id"]. "</td><td>" .$row["p_name"]. "</td><td>" .$row["p_cat"]. "</td><td>" .$row["p_brand"]. "</td><td>" .$row["p_price"]. "</td><td>" .$row["p_dis"]. "</td><td>" .$row["p_desc"]. "</td><td><img src='images/".$row["p_img"]."' width='100px' height='100px'></td><td>" .$row["p_qty"]. "</td><td>" .$row["p_seller"]. "</td>></tr>";
									} 

...
$sqe="insert into purchase(invoice,pid,uid,price,qty,dis,dc,subt,t_price,curdate) values('$inv',$pid,'$uid','$pr','$qty','$dis','$dc','$st','$subt',NOW());";
mysqli_query($con,$sqe);
					...
					<div class="resp-tabs-container hor_1">
						...
						<div>
							<form action="success1.php" method="post" class="creditly-card-form agileinfo_form">
								<div class="creditly-wrapper wthree, w3_agileits_wrapper">
									<div class="credit-card-wrapper">
										...
										<h3 class="tittle-w3l" style="color:black; margin-top: 0.83em;margin-bottom: 0.53em;">Delivery Charge <span>₹<input type="text" name="d_c" value="50" readonly></span></h3>
										<h3 class="wthree_text_info"> <span> </span></h3>
										<h3 class="wthree_text_info"> <span> </span></h3>
